...
function zanblog_scripts_styles() {
  ...
  wp_enqueue_script( 'zanblog-script', get_template_directory_uri() . '/ui/js/zanblog.js', array('jquery'), '2.0.1');

  // Add zanblog main css.
  wp_enqueue_style( 'zanblog-style', get_stylesheet_uri(), array(), '2.0.1');
